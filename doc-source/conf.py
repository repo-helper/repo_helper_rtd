...
documentation_summary = "Manage ReadTheDocs documentation with repo-helper."
...
rst_prolog = f""".. |pkgname| replace:: repo_helper_rtd
.. |pkgname2| replace:: ``repo_helper_rtd``
